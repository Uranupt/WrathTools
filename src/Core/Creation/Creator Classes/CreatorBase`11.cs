...
{
  public abstract class CreatorBase<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, TArg9, TArg10, TResult>
    : CreatorBase, ICreator<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, TArg9, TArg10, TResult>
  {
    ...
    private readonly ArgsSignature _signature =
      new(new Type[] { typeof(TArg1), typeof(TArg2), typeof(TArg3), typeof(TArg4), typeof(TArg5), typeof(TArg6),
        typeof(TArg7), typeof(TArg8), typeof(TArg9), typeof(TArg10)});
    ...
    object ICreatorWithArgs<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, TArg9, TArg10>.Create(
    ...
    TResult ICreatorFor<TResult>.Create(params object[] args)
    {
      ...
      return Create((TArg1)args[0], (TArg2)args[1], (TArg3)args[2], (TArg4)args[3], (TArg5)args[4], (TArg6)args[5],
        (TArg7)args[6], (TArg8)args[7], (TArg9)args[8], (TArg10)args[9]);
    }
